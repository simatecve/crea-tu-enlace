        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-[1100px] flex flex-col md:flex-row items-center justify-center relative z-10 px-4 py-8">
            ...
            <div className="flex flex-col items-center md:items-start w-full md:w-[55%] text-white px-4 md:px-10 text-left">
              ...
              {/* .small-text */}
              <p className="text-white font-semibold text-[21px] md:text-xl mb-0">
              ...
              {(() => {
                ...
                if (parts.length > 1) {
                  return (
                    <p className="text-white font-extrabold text-[29px] md:text-[46px] lg:text-[56px] leading-[1.05] uppercase max-w-[500px]">
                       {parts[0]}BONO
              ...
              {(page as any).promo_subtitle && (
                <p className="text-white font-extrabold text-[25px] md:text-[40px] lg:text-[50px] leading-[1.05] uppercase max-w-[500px]">
                  {(page as any).promo_subtitle}
                </p>
              )}
