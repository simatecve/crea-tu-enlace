          ...
          <div className="w-full max-w-[1100px] flex flex-col md:flex-row items-center justify-center relative z-10 px-4 py-8">
            ...
            <div className="flex flex-col items-center md:items-start w-full md:w-[55%] text-white px-4 md:px-10">
              ...
              <button
                ...
                className="w-full max-w-[320px] py-4 px-8 rounded-lg text-black font-extrabold text-xl tracking-wide transition-all duration-200 hover:scale-105 mb-5 uppercase"
              ...
              <div className="w-full max-w-[380px] mb-4" style={{ borderTop: "3px dotted rgba(255,156,66,0.5)", borderImage: "none" }} />
